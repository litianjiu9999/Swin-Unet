...
```bash
sh train.sh or python train.py --dataset Synapse --cfg configs/swin_tiny_patch4_window7_224_lite.yaml --root_path ./data/Synapse/train_npz --max_epochs 150 --output_dir outputs  --img_size 224 --base_lr 0.05 --batch_size 24
```
